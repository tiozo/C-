...
unsigned long long dp[20][504][512][2];
string s;
int k;

unsigned long long solve(int pos,unsigned long long Mod, int mask, int tight, int last)
{
...
unsigned long long eval(string a)
{
